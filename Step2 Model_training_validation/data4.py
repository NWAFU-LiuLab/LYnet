...
#train_GPSD
train_AAC=AAC(r"../paper_NO.4/seqset/Train.FASTA")
train_CTDC=libsvm_file_read(r"../paper_NO.4/dataset/train_CTDC.LibSVM")
train_CTDT=libsvm_file_read(r"../paper_NO.4/dataset/train_CTDT.LibSVM")
train_CTDD=libsvm_file_read(r"../paper_NO.4/dataset/train_CTDD.LibSVM")
#train_GAAPC
train_GAAC=GAAC(r"../paper_NO.4/seqset/Train.FASTA")
train_GDPC=libsvm_file_read(r"../paper_NO.4/dataset/train_GDPC.LibSVM")
train_GTPC=libsvm_file_read(r"../paper_NO.4/dataset/train_GTPC.LibSVM")
#train_ASDC
train_ASDC=libsvm_file_read(r"../paper_NO.4/dataset/train_ASDC.LibSVM")
#train_PAAC
train_PAAC=libsvm_file_read(r"../paper_NO.4/dataset/train_PAAC.LibSVM")


train_APAAC=libsvm_file_read(r"../paper_NO.4/dataset/train_APAAC.LibSVM")
train_CKSAAGP=libsvm_file_read(r"../paper_NO.4/dataset/train_CKSAAGP.LibSVM")
train_CKSAAP=libsvm_file_read(r"../paper_NO.4/dataset/train_CKSAAP.LibSVM")
train_CTriad=libsvm_file_read(r"../paper_NO.4/dataset/train_CTriad.LibSVM")
train_DDE=libsvm_file_read(r"../paper_NO.4/dataset/train_DDE.LibSVM")
train_DistancePair=libsvm_file_read(r"../paper_NO.4/dataset/train_DistancePair.LibSVM")
train_DPC=libsvm_file_read(r"../paper_NO.4/dataset/train_DPC.LibSVM")
#train_QSOrder=libsvm_file_read(r"dataset/train_QSOrder.LibSVM")
train_SOCNumber=libsvm_file_read(r"../paper_NO.4/dataset/train_SOCNumber.LibSVM")
train_k_mer=read_k_mer(r"../paper_NO.4/dataset/train_2_mer_.csv")
...
rnn_train_feature=np.concatenate((train_AAC,train_CTDC,train_CTDT,train_CTDD,train_GAAC,train_GDPC,
                                                    train_GTPC,train_ASDC,train_PAAC,
                                                    train_APAAC,train_CKSAAGP,train_CKSAAP,train_CTriad,train_DDE,train_DistancePair,train_DPC,
                                                    train_SOCNumber,train_k_mer),axis=1)
...
#test_GPSD
test_AAC=AAC(r"../paper_NO.4/seqset/Test.FASTA")
test_CTDC=libsvm_file_read(r"../paper_NO.4/dataset/test_CTDC.LibSVM")
test_CTDT=libsvm_file_read(r"../paper_NO.4/dataset/test_CTDT.LibSVM")
test_CTDD=libsvm_file_read(r"../paper_NO.4/dataset/test_CTDD.LibSVM")
#test_GAAPC
test_GAAC=GAAC(r"../paper_NO.4/seqset/Test.FASTA")
test_GDPC=libsvm_file_read(r"../paper_NO.4/dataset/test_GDPC.LibSVM")
test_GTPC=libsvm_file_read(r"../paper_NO.4/dataset/test_GTPC.LibSVM")
#test_ASDC
test_ASDC=libsvm_file_read(r"../paper_NO.4/dataset/test_ASDC.LibSVM")
#test_PAAC
test_PAAC=libsvm_file_read(r"../paper_NO.4/dataset/test_PAAC.LibSVM")

test_APAAC=libsvm_file_read(r"../paper_NO.4/dataset/test_APAAC.LibSVM")
test_CKSAAGP=libsvm_file_read(r"../paper_NO.4/dataset/test_CKSAAGP.LibSVM")
test_CKSAAP=libsvm_file_read(r"../paper_NO.4/dataset/test_CKSAAP.LibSVM")
test_CTriad=libsvm_file_read(r"../paper_NO.4/dataset/test_CTriad.LibSVM")
test_DDE=libsvm_file_read(r"../paper_NO.4/dataset/test_DDE.LibSVM")
test_DistancePair=libsvm_file_read(r"../paper_NO.4/dataset/test_DistancePair.LibSVM")
test_DPC=libsvm_file_read(r"../paper_NO.4/dataset/test_DPC.LibSVM")
#test_QSOrder=libsvm_file_read(r"dataset/test_QSOrder.LibSVM")
test_SOCNumber=libsvm_file_read(r"../paper_NO.4/dataset/test_SOCNumber.LibSVM")
test_k_mer=read_k_mer(r"../paper_NO.4/dataset/test_2_mer_.csv")
...
rnn_test_feature=np.concatenate((test_AAC,test_CTDC,test_CTDT,test_CTDD,test_GAAC,test_GDPC,
                                 test_GTPC,test_ASDC,test_PAAC,
                                 test_APAAC,test_CKSAAGP,test_CKSAAP,test_CTriad,test_DDE,test_DistancePair,test_DPC,
                                 test_SOCNumber,test_k_mer),axis=1)
...
def rnn(max_len,depth,l1=64,l2=512,l3=256,gamma=1e-4,lr=1e-4):
    model=models.Sequential()
...
f=open("../paper_NO.4/seqset/Train.FASTA",'r')
train_lines=f.readlines()
train_seq,train_label=read_data(train_lines)
f.close()

f=open("../paper_NO.4/seqset/Test.FASTA",'r')
