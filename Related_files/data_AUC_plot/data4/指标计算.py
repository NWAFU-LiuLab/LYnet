...
fun("data4-model2-train.npz")
fun("data4-model2-test.npz")

fun("data4-model3-train.npz")
fun("data4-model3-test.npz")

fun("data4-model4-train.npz")
fun("data4-model4-test.npz")