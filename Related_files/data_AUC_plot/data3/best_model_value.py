...
model2_train=np.load("data3-model2-train.npz")
model2_test=np.load("data3-model2-test.npz")
model3_train=np.load("data3-model3-train.npz")
model3_test=np.load("data3-model3-test.npz")
model4_train=np.load("data3-model4-train.npz")
model4_test=np.load("data3-model4-test.npz")
