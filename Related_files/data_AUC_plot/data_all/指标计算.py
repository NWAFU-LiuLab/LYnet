...
fun("data_all-model2-train.npz")
fun("data_all-model2-test.npz")

fun("data_all-model3-train.npz")
fun("data_all-model3-test.npz")

fun("data_all-model4-train.npz")
fun("data_all-model4-test.npz")